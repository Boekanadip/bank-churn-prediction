...
# %%
DATA_PATH = r"C:\Users\ASUS\Downloads\bank-churn-prediction-main\bank-churn-prediction-main\data\Bank Customer Churn Prediction.csv"  # <-- sesuaikan path lokal kamu
...
# %% [markdown]
# ### 4f. Cross-validation (tidak ada di script asli — tambahan)
...
df_corr = pd.concat([df_corr, pd.get_dummies(df_corr["country"], prefix="country")], axis=1)
 
corr_cols = [
    "credit_score", "age", "tenure", "balance", "products_number",
    "credit_card", "active_member", "estimated_salary",
    "gender_encoded",
] + [c for c in df_corr.columns if c.startswith("country_")] + ["churn"]
...
# %% [markdown]
# ### C. Tuning Threshold Random Forest vs F1 optimal XGBoost
...
# %% [markdown]
# ### C1. Bandingkan detail: threshold default (0.5) vs threshold optimal
